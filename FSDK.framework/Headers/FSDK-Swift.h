...
SWIFT_MODULE_NAMESPACE_PUSH("FSDK")
...
@interface ServiceManager (SWIFT_EXTENSION(FSDK)) <MCNearbyServiceAdvertiserDelegate>
- (void)advertiser:(MCNearbyServiceAdvertiser * _Nonnull)advertiser didReceiveInvitationFromPeer:(MCPeerID * _Nonnull)peerID withContext:(NSData * _Nullable)context invitationHandler:(void (^ _Nonnull)(BOOL, MCSession * _Nullable))invitationHandler SWIFT_AVAILABILITY(ios,introduced=7.0);
...
@interface ServiceManager (SWIFT_EXTENSION(FSDK)) <MCSessionDelegate>
...
@interface ServiceManager (SWIFT_EXTENSION(FSDK)) <MCNearbyServiceBrowserDelegate>
